...
-- 결과 107개
-- Why ?
--  전체 사원수 107. 부서에 소속된 사원수 106 이다 (소속되지 않은 사원수 1)
--  전체 부서 수 27. 사원이 있는 부서는 11 개이다 (사원이 없는 부서 16개)

-- 우선, 오른쪽과 상관없는 왼쪽 인원 1명을 구한다.
-- 여기에, 두 테이블을 inner join 을 통해 산출했을 경우 구해졌을 수치 106 을 더한다.
-- 따라서, 1 + 106 = 107
...
CROSS JOIN
    departments
;
-- employess * departments 갯수 대로 결과가 나옴 (107 * 27 = 2889)
*/
